...
<section class="space-y-3">
    ...
    <div class="space-y-1.5 text-xs md:text-sm">
        ...
        <textarea id="bio" name="bio" rows="3"
            class="w-full rounded-2xl border border-slate-200 px-3 py-2 bg-white text-slate-800 focus:outline-none focus:ring-2 focus:ring-sky-400/70">{{ old('bio', $bio) }}</textarea>
    </div>
</section>
