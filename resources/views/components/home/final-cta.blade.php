<section class="mb-6 md:mb-10">
    <div
        class="bg-white dark:bg-slate-800 rounded-3xl shadow-xl shadow-slate-200/80 dark:shadow-slate-900/80 border border-slate-100 dark:border-slate-700 px-5 md:px-8 py-6 md:py-8 text-center md:max-w-2xl md:mx-auto">
        <h2 class="text-base md:text-2xl font-semibold text-slate-900 dark:text-white">
