...
@if ($event)
    <section class="mb-10 md:mb-14">
        ...
        <article
            class="relative overflow-hidden rounded-3xl bg-gradient-to-br from-sky-700 via-indigo-500 to-purple-500 text-white shadow-xl md:grid md:grid-cols-[2fr,3fr] md:items-stretch">
